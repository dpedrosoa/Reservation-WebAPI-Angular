...
namespace ReservationSystem.Controllers
{
    ...
    public class ContactTypesController : ControllerBase
    {
        ...
        public ContactTypesController(ReservationDbContext context, IContactTypeRepository contactTypeRepository)
        {
            _context = context;
        ...
        public async Task<ActionResult<IEnumerable<ContactType>>> GetContactTypes()
        {
            ...
            return await _contactTypeRepo.GetAllContactTypesAsync();
        }
